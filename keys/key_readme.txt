...
XLA_FixedArsenal_v2_0_3.bikey -- will be used only for this version of @XLA_FixedArsenal.  Again, do not use if you use PwS or another automatic updater in your clan. Will require updating the key on the server every single time this mod is updated.