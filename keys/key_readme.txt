...
XLA_FixedArsenal_v2_1.bikey -- will be used to sign all v2.1.x versions of @XLA_FixedArsenal. Do not use if you use PwS or another automatic updater in your clan. This ensures everybody has the same features but will require an update of the server key with virtually any update of the mod.
XLA_FixedArsenal_v2_1_0.bikey -- will be used only for this version of @XLA_FixedArsenal.  Again, do not use if you use PwS or another automatic updater in your clan. Will require updating the key on the server every single time this mod is updated.